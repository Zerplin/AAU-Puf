...
class ArbiterPufDelayII(gym.Env):
    def __init__(self, challenge_bit_length=16, M_delay_granularity=0, arbiter_seed=1337):
    ...
    def step(self, action):
        ...
        if self.puf_stage == (self.challenge_bit_length - 1):
            ...
            evaluated_action = 1 if self.accumulated_delay_delta >= 1 else 0
